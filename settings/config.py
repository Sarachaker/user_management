...
class Settings(BaseSettings):
    ...
    MINIO_ACCESS_KEY: str = Field(default= "My_minio_access_key", description="Minio access key")
    MINIO_SECRET_KEY: str = Field(default= "My_minio_secret_key", description="Minio secret key")
